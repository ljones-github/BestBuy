...
public class BBHomePageTest extends TestBase{
	...
	public void clickCreditCards() throws IOException
	{
		...
		s.doubleClick(bbhp.getCreditCardsLink()).pause(Duration.ofMillis(6000)).build().perform();
	...
	public void clickTopDeals() throws IOException
	{
		...
		s.doubleClick(bbhp.getTopDealsLink()).pause(Duration.ofMillis(6000)).build().perform();
		...
		Assert.assertTrue(driver.getTitle().contains("Top"));
	}
	...
	public void clickDealOfTheDay() throws IOException
	{
		...
		s.doubleClick(bbhp.getDealOfTheDayLink()).pause(Duration.ofMillis(6000)).build().perform();
		...
		Assert.assertTrue(driver.getTitle().contains("Day"));
	}
	...
	public void clickGiftCards() throws IOException
	{
		...
		s.doubleClick(bbhp.getGiftCardsLink()).pause(Duration.ofMillis(6000)).build().perform();
	...
	public void clickForYourBusiness() throws IOException
	{
		...
		s.doubleClick(bbhp.getForYourBusinessLink()).pause(Duration.ofMillis(6000)).build().perform();
		log.debug("Class: " + BBHomePageTest.class.getName() + " || Debug: Button successfully clicked || Method: " + methodName);
	...
	@Test
	public void clickBackToSchool() throws IOException
	{
		methodName = new Throwable().getStackTrace()[0].getMethodName();
		Actions s = new Actions(driver);
		BestBuyHomePage bbhp = new BestBuyHomePage(driver);
		...
		s.moveToElement(bbhp.getBackToSchoolLink()).pause(Duration.ofMillis(2000)).build().perform();
		s.doubleClick(bbhp.getBackToSchoolLink()).pause(Duration.ofMillis(6000)).build().perform();
		log.debug("Class: " + BBHomePageTest.class.getName() + " || Debug: Button successfully clicked || Method: " + methodName);
		...
		Assert.assertTrue(driver.getTitle().contains("School"));
	}
